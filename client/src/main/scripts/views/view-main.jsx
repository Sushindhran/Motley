		...
		serviceTurnstile.getCaptionResponse(date, time).then(
			function(response) {
				_formatResponseForEntries(response, function(ans) {
					console.log('Success', JSON.stringify(ans));
					this.setState({
						data: {
							max: 10000000,
							data: ans
	...
	render: function() {
		return (
			<div className="container-fluid">
				<div>
					<DatePicker inputFormat="MM-DD-YYYY HH:MM:SS" onChange={this.dateChange}/>
					<button className="button" onClick={this.getTurnstileData}/>
				</div>
				<div className="row">
